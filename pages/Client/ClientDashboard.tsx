      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <div className="bg-white p-6 md:p-8 rounded-[2.5rem] md:rounded-[3rem] border border-gray-100 shadow-sm flex flex-col justify-between h-full">
           ...
           <div className="mt-4 md:mt-6">
              ...
              <h3 className="text-2xl md:text-3xl font-black text-gray-900 tracking-tighter italic">{metrics?.sales24h || 0} vtas</h3>
           </div>
        </div>

        <div className={`p-6 md:p-8 rounded-[2.5rem] md:rounded-[3rem] border shadow-sm flex flex-col justify-between h-full transition-all ${health.bg} ${health.color.replace('text-', 'border-')}`}>
           <div className="flex justify-between items-start">
           ...
           <div className="mt-4 md:mt-6">
              ...
              <h3 className={`text-2xl md:text-3xl font-black uppercase italic tracking-tighter ${health.color}`}>{health.label}</h3>
           </div>
        </div>
      </div>
